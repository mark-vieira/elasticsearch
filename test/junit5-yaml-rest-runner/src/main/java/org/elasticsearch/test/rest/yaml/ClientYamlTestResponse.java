...
import org.elasticsearch.test.ObjectPath;
        ...
        if (response.getEntity() != null) {
            ...
            try {
                ...
                if (bodyContentType != null) {
                    this.parsedResponse = ObjectPath.createFromXContent(bodyContentType.xContent(), bytes);
                }
                this.body = bytes;
            } catch (IOException e) {
        ...
        if (bodyAsString == null && body != null) {
            ...
            if (bodyContentType == null
                ...
                try (XContentBuilder jsonBuilder = XContentFactory.jsonBuilder()) {
                    ...
                    bodyAsString = XContentUtils.toString(jsonBuilder);
                } catch (IOException e) {
