...
public class GreaterThanAssertion extends Assertion {
    ...
    private static final Logger logger = LoggerFactory.getLogger(GreaterThanAssertion.class);
    ...
    protected void doAssert(Object actualValue, Object expectedValue) {
        ...
        logger.trace(() -> "assert that [" + actualValue + "] is greater than [" + finalExpectedValue + "] (field: [" + getField() + "])");
        assertThat(
