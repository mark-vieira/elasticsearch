...
public class LessThanOrEqualToAssertion extends Assertion {
    ...
    private static final Logger logger = LoggerFactory.getLogger(LessThanOrEqualToAssertion.class);
    ...
    protected void doAssert(Object actualValue, Object expectedValue) {
        ...
        logger.trace(
            () -> "assert that [" + actualValue + "] is less than or equal to [" + finalExpectedValue + "] (field: [" + getField() + "])"
        );
        assertThat(
