...
public abstract class Assertion implements ExecutableSection {
    ...
    protected final Object resolveExpectedValue(YamlRestTestExecutionContext executionContext) throws IOException {
    ...
    protected final Object getActualValue(YamlRestTestExecutionContext executionContext) throws IOException {
    ...
    @Override
    public final void execute(YamlRestTestExecutionContext executionContext) throws IOException {
