...
public class LessThanAssertion extends Assertion {
    ...
    private static final Logger logger = LoggerFactory.getLogger(LessThanAssertion.class);
    ...
    protected void doAssert(Object actualValue, Object expectedValue) {
        ...
        logger.trace(() -> "assert that [" + actualValue + "] is less than [" + finalExpectedValue + "] (field: [" + getField() + "])");
        assertThat(
