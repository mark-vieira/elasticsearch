...
public class ObjectPath {
    ...
    public static ObjectPath createFromXContent(XContent xContent, byte[] input) throws IOException {
        try (
            XContentParser parser = xContent.createParser(
                XContentParserConfiguration.EMPTY.withDeprecationHandler(DeprecationHandler.THROW_UNSUPPORTED_OPERATION),
                input
            )
        ) {
