                ...
                if ("documentation".equals(parser.currentName())) {
                        ...
                        if (headerName.equals("accept")) {
                            if (parser.nextToken() != XContentParser.Token.START_ARRAY) {
                                throw new IllegalStateException(
                                    apiName + " API: [headers.accept] must be an array @ " + parser.getTokenLocation().toString()
                                );
                            }
                            ...
                            if (parser.nextToken() != XContentParser.Token.START_ARRAY) {
                                throw new IllegalStateException(
                                    apiName + " API: [headers.content_type] must be an array @ " + parser.getTokenLocation().toString()
                                );
                            }
                    ...
                    while (parser.nextToken() != XContentParser.Token.END_OBJECT) {
                        ...
                        if ("paths".equals(currentFieldName)) {
                            if (parser.nextToken() != XContentParser.Token.START_ARRAY) {
                                throw new IllegalStateException(
                                    apiName + " API: [paths] must be an array @ " + parser.getTokenLocation().toString()
                                );
                            }
                                ...
                                while (parser.nextToken() != XContentParser.Token.END_OBJECT) {
                                    if ("path".equals(parser.currentName())) {
                                        ...
                                        if (parser.nextToken() != XContentParser.Token.START_ARRAY) {
                                            throw new IllegalStateException(
                                                apiName
                                                    + " API: expected [methods] field in rest api definition to hold an array @ "
                                        ...
                                        if (parser.nextToken() != XContentParser.Token.START_OBJECT) {
                                            throw new IllegalStateException(
                                                apiName
                                                    + " API: expected [parts] field in rest api definition to hold an object @ "
                                                    + parser.getTokenLocation().toString()
                                            );
                                        }
                                        while (parser.nextToken() == XContentParser.Token.FIELD_NAME) {
                                        ...
                                        if (parser.nextToken() != XContentParser.Token.START_OBJECT) {
                                            throw new IllegalStateException(
                                                apiName
                                                    + " API: expected [deprecated] field in rest api definition to hold an object @ "
                                                    + parser.getTokenLocation().toString()
                                            );
                                        }
                                        parser.skipChildren();
                            ...
                            throw new IllegalStateException(
                                apiName + " API: unsupported field [" + parser.currentName() + "] @ " + parser.getTokenLocation().toString()
                            );
                        }
                    }
                    ...
                    if (parser.nextToken() != XContentParser.Token.START_OBJECT) {
                        throw new IllegalStateException(
                            apiName
                                + " API: expected [params] field in rest api definition to contain an object @ "
                                + parser.getTokenLocation().toString()
                        );
